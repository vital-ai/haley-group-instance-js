...
var GroupListWidget = __webpack_require__(3);
var GroupInstanceWidget = __webpack_require__(4);
var QuestionModule = __webpack_require__(5);
module.exports = {
    GroupAPI: GroupAPI,
...
var GroupAPI = /** @class */ (function () {
    function GroupAPI(vitaljs, objList, instanceList) {
        ...
        (objList || []).forEach(function (obj) { return _this.msgRL.addResult(obj); });
        (instanceList || []).forEach(function (obj) { return _this.msgRL.addResult(obj); });
    }
