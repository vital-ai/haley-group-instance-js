...
export const TYPE_HALEY_OBJECT_ANSWER_INSTANCE = 'http://vital.ai/ontology/haley-ai-question#HaleyObjectAnswerInstance';
...
export const TYPE_HALEY_OBJECT_ANSWER = 'http://vital.ai/ontology/haley-ai-question#HaleyObjectAnswer';
...
export const MAPPING_ANSWER_TO_ANSWER_INSTANCE = new Map<string, string>([
    ...
    [TYPE_HALEY_OBJECT_ANSWER, TYPE_HALEY_OBJECT_ANSWER_INSTANCE],
...
export const EDGE_ANSWER_CONSTRAINT = 'http://vital.ai/ontology/haley-ai-question#Edge_hasAnswerConstraint';
export const EDGE_ANSWER_DEPENDENCY = 'http://vital.ai/ontology/haley-ai-question#Edge_hasAnswerDependency';
