...
export const dataLackOfSectionObject = [
  group1,
  edgeGroupToSection,
  edgeSectionToQuestion1,
  rootQuestion1,
...
export const dataLackOfRowObject = [
  group1,
  edgeGroupToSection,
  rootSection1,
  edgeSectionToQuestion1,
...
export const dataLackOfQuestionObject1 = [
  group1,
  edgeGroupToSection,
  rootSection1,
  edgeSectionToQuestion1,
...
export const dataLackOfQuestionObject2 = [
  group1,
  edgeGroupToSection,
  rootSection1,
  edgeSectionToQuestion1,
...
export const dataLackOfAnswerObject = [
  group1,
  edgeGroupToSection,
  rootSection1,
  edgeSectionToQuestion1,
...
export const dataLackOfEdgeToAnswerEdgeObject = [
  group1,
  edgeGroupToSection,
  rootSection1,
  edgeSectionToQuestion1,
